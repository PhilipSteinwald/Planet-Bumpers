...
public class GameBoardUI extends Canvas {
	...
	public void popupInfo(){
		Label secondLabel = new Label(" Starte als kleiner Stern und kämpfe ums Überleben im großen, weiten Weltraum! \r\n \r\n Du vergrößerst deinen Stern indem du gleich große Sterne besiegst. Der rechte \r\n Stern gewinnt bei einer Kollision des Spielersterns, es sei denn der linke Stern ist größer. \r\n \r\n Lass dich nicht in die Enge treiben und pass auf Schwarze löcher auf. Du gewinnst \r\n wenn kein anderer Stern mehr übrig ist.");
		secondLabel.setFont(new Font("Arial", 16));

		StackPane secondaryLayout = new StackPane();
		secondaryLayout.getChildren().add(secondLabel);

		Scene secondScene = new Scene(secondaryLayout, 650, 250);
